...
export const SplitButton = ({ buttonText, items = [], mainButtonAction, pos = 'right-0' }) => {
  return (
    <div className="inline-flex rounded-md shadow-sm">
      ...
      <Menu as="div" className="relative -ml-px block">
        ...
        <Transition
          ...
          <Menu.Items
            className={`absolute ${pos}  z-10 mt-2 -mr-1 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}>
            <div className="py-1">
              {items?.map((item) => (
