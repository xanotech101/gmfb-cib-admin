...
import { TransactionUsageTable } from './components/TransactionTable';
...
const RenderData = ({ data, initialSerialNumber }) => {
  if (data?.results?.length === 0 || !data) {
    ...
    return <TransactionUsageTable data={data} initialSerialNumber={initialSerialNumber} />;
  }
};

export const TransactionUsage = () => {
