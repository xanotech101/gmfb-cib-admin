...
import { RequestModal } from './Request/ViewRequest/ViewRequest';
              ...
              <li key={person.handle} className="py-4">
                <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row ">
                  ...
                  <div>
                    ...
                    <span className="inline-flex items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50 mr-4 cursor-pointer mt-4">
                      Accept
                    </span>
                    <span className="inline-flex items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50 mr-4 cursor-pointer mt-4">
                      Decline
