...
export const Corporate = () => {
  ...
  console.log('🚀 ~ file: corperate.js:12 ~ Corporate ~ data:', data);
  return (
    <div className="Dash ml-0 px-6 md:ml-10 sm:ml-0 lg:ml-8 pt-10 w-full">
      <Container>
        <div className="p-3">
          <div className="flex md:flex-col sm:flex-col lg:flex-row flex-col justify-between gap-2">
            <div>
              <Heading>Corporate Information</Heading>
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Personal details and application.
              </p>
            </div>
            <Link to="/corperate/create">
              <Button>Create corporate user</Button>
            </Link>
          </div>
              ...
              <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                ...
                <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                  ...
                  <span className="ml-4 flex-shrink-0">
                    <button
                      type="button"
                      className="rounded-md bg-white font-medium grooming-text focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                      Update
                    </button>
                  </span>
